    ...
    function startWidget() {
        ...
        function parseSarineInfos() {
            ...
            $('[' + attrNames.sarineInfo + '], [' + attrNames.sarineInfoDisplay + ']').each(function() {
                var $el = $(this),
                    field = $el.attr(attrNames.sarineInfo) || $el.attr(attrNames.sarineInfoDisplay),
                    fieldArr = field.split('.'),
                    displayField = fieldArr[1],
                    isShowDisplay = $el.attr(attrNames.sarineInfoDisplay),
                    value = tplUtils.recurse(stone, fieldArr),
                    item = null;
